...
public class TestConfig implements CommandLineRunner {
    ...
    public void run(String... args) throws Exception {
        ...
        Clothes clothes1 = new Clothes(null, "Red T-shirt", 20.33, "100% Cotton", "/images/image1.png", Size.MEDIUM, Category.TSHIRT, Color.RED);
        Clothes clothes2 = new Clothes(null, "Black skirt", 12.42, "45% Cotton, 55% Polyester", "/images/image2.png", Size.SMALL, Category.SKIRT, Color.BLACK);
        Clothes clothes3 = new Clothes(null, "Blue coat", 45.53, "90% Cotton, 10% wool", "/images/image3.png", Size.LARGE, Category.COAT, Color.BLUE);
