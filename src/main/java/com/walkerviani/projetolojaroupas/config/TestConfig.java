...
public class TestConfig implements CommandLineRunner {
    ...
    public void run(String... args) throws Exception {
        ...
        Clothes clothes1 = new Clothes("Red T-shirt", new BigDecimal("20.33"), "100% Cotton", "/images/image1.png", Size.MEDIUM, new Category("T-shirt"), Color.RED, 5);
        Clothes clothes2 = new Clothes("Black skirt", new BigDecimal("12.42"), "45% Cotton, 55% Polyester", "/images/image2.png", Size.SMALL, new Category("Skirt"), Color.BLACK, 8);
        Clothes clothes3 = new Clothes("Blue coat", new BigDecimal("45.43"), "90% Cotton, 10% wool", "/images/image3.png", Size.LARGE, new Category("Coat"), Color.BLUE, 9);
